// @algorithm StringPatternCheck
// @category StringProcessing / Validation
// @data-structure Array, CharArray
// @complexity Time: O(n^2), Space: O(1)
// @variant Part1: VowelsAndDoubleLetters, Part2: RepeatingPairsAndSandwich
